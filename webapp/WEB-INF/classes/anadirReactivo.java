    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<!DOCTYPE html><html>\n"
                    ...
                    + "                    <span class=\"mdl-layout-title\">Añadir Reactivo</span>\n"
                    ...
                    + "                    <a class=\"mdl-navigation__link seleccionado\" href=\"\">Añadir Reactivos</a>\n"
                    ...
                    + "                        <h2 class=\"mdl-card__title-text\">Añadir Reactivos</h2>\n"
                    + "                        <p class=\"mdl-card__supporting-text\">Completa el siguiente formulario para añadir un reactivo a la base de datos:</p>\n"
                    ...
                    + "                            </div>\n"
                    + "                            <div class=\"mdl-textfield mdl-js-textfield mdl-textfield--floating-label\" style=\"width: 100%\">\n"
                    + "                                <input class=\"mdl-textfield__input\" type=\"email\" id=\"opcionC\" name=\"opcionC\" required>\n"
                    + "                                <label class=\"mdl-textfield__label\" for=\"opcionC\">Opcion C</label>\n"
                    + "                            </div>\n"
                    + "                            <div class=\"mdl-textfield mdl-js-textfield mdl-textfield--floating-label\" style=\"width: 100%\">\n"
                    + "                                <input class=\"mdl-textfield__input\" type=\"email\" id=\"opcionD\" name=\"opcionD\" required>\n"
                    + "                                <label class=\"mdl-textfield__label\" for=\"opcionD\">Opcion D</label>\n"
                    + "                            </div>\n"
                    + "                            <div class=\"mdl-textfield mdl-js-textfield mdl-textfield--floating-label\" style=\"width: 100%\">\n"
                    + "                                <input class=\"mdl-textfield__input\" type=\"email\" id=\"respuesta\" name=\"respuesta\" required>\n"
